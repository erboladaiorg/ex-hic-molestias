...
__Motto of `@erboladaiorg/ex-hic-molestias` is simple__: *create the smallest possible CSS-in-JS library and provide all features of any other library through addons.*

- __Only [0.5 Kb](https://bundlephobia.com/result?p=@erboladaiorg/ex-hic-molestias@1.15.3)__ in base configuration, *e.g. [`styled-components`](https://github.com/styled-components/styled-components) is [15.1Kb](https://bundlephobia.com/result?p=styled-components@3.2.5)*
...
> For pre-configured simple-to-use package see [`nano-theme`](https://github.com/streamich/nano-theme), which builds on top of `@erboladaiorg/ex-hic-molestias`.
...
[npm-url]: https://www.npmjs.com/package/@erboladaiorg/ex-hic-molestias
[npm-badge]: https://img.shields.io/npm/v/@erboladaiorg/ex-hic-molestias.svg
[travis-url]: https://travis-ci.org/streamich/@erboladaiorg/ex-hic-molestias
[travis-badge]: https://travis-ci.org/streamich/@erboladaiorg/ex-hic-molestias.svg?branch=master
